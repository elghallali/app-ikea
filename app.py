...
st.markdown('# <img src="https://raw.githubusercontent.com/RabiaaSL00/app-ikea/main/images/logo%20ikea.webp" alt="Ikea Logo" width=100/> Ikea Application',unsafe_allow_html=True)
